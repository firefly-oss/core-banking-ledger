    ...
    public Mono<String> generateBalanceSheetReport(LocalDate asOfDate) {
        ...
        return calculateTotalsByAccountType(null, asOfDateTime)
                .map(totals -> {
                    ...
                    report.append("Liabilities: ").append(totalLiabilities.abs()).append("\n");
                    report.append("Equity: ").append(totalEquity.abs()).append("\n");
                    report.append("Total Liabilities and Equity: ").append(totalLiabilities.abs().add(totalEquity.abs())).append("\n");
