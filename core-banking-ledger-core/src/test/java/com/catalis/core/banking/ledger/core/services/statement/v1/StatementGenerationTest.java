...
public class StatementGenerationTest {
    ...
    void setUp() {
        ...
        transaction1.setTransactionStatus(TransactionStatusEnum.POSTED);
        ...
        transaction2.setTransactionType(TransactionTypeEnum.WITHDRAWAL);
        transaction2.setTransactionStatus(TransactionStatusEnum.POSTED);
        ...
        transaction3.setTransactionStatus(TransactionStatusEnum.POSTED);
    ...
    void generateAccountStatement_Success() {
        // Arrange
        when(transactionService.getTransactionsByAccountId(eq(accountId)))
        ...
        // Verify interactions
        verify(transactionService).getTransactionsByAccountId(eq(accountId));
    ...
    void generateAccountSpaceStatement_Success() {
        ...
        when(transactionService.getTransactionsByAccountSpaceId(eq(accountSpaceId)))
                .thenReturn(Flux.fromIterable(mockTransactions));
        ...
        // Verify interactions
        verify(transactionService).getTransactionsByAccountSpaceId(eq(accountSpaceId));
        verify(mapper).toEntity(any(StatementMetadataDTO.class));
        verify(repository).save(any(Statement.class));
